                                    ...
                                    <div class="col-sm-3">
                                        <div class="single-item">
                                            ...
                                            <div class="single-item-header">
                                                <a style="height: 300px, width:200px" href="/detail/{id}"><img src="/source/image/product/{{$new->image}}" alt=""></a>
                                            </div>
                                            ...
                                            <div class="single-item-caption">
                                                ...
                                                <a class="beta-btn primary" href="/detail/{id}">Details <i class="fa fa-chevron-right"></i></a>
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="beta-products-list">
                                ...
                                @foreach($sanpham_khuyenmai as $spkm)
                                    <div class="col-sm-3">
                                        <div class="single-item">
                                            <div class="single-item-header">
                                                <a href="/detail/{id}"><img src="/source/image/product/{{$spkm->image}}" alt=""></a>
                                            </div>
                                            <div class="single-item-body">
